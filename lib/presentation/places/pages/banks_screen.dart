// vive_huanchaco/lib/features/places/presentation/pages/banks_screen.dart
  ...
  Widget build(BuildContext context) {
    return const Center(
      child: Column(
        ...
        children: [
          FaIcon(FontAwesomeIcons.buildingColumns, size: 80, color: Colors.indigo), // Icono de banco
          SizedBox(height: 10),
          Text('Sección de Bancos', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
          Text('Contenido de bancos, sedes, cajeros, agentes...'),
        ],
      ),
    );
  }
